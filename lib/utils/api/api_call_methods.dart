import 'package:newGetxCLI/utils/api/api_status_code.dart';
import 'package:newGetxCLI/utils/api/app_envirments.dart';
import 'package:newGetxCLI/utils/services/local_storage_services/local_storages_string.dart';
import 'package:newGetxCLI/utils/services/local_storage_services/localstorage_services.dart';
import 'package:newGetxCLI/utils/api/response_model.dart';
import 'package:get/get.dart';
import 'package:newGetxCLI/utils/keys/api_keys.dart';
import 'package:newGetxCLI/utils/strings.dart';
import 'package:newGetxCLI/utils/ui_helper.dart/app_snack_bar.dart';
  ...
  static ResponseModel sendResponseToModel(
    ...
    switch (statusCode) {
      ...
      case APIStatusCode.alreadyExistError:
        AppSnackBar.showSnackBarErrorMassage(massage: Strings.all);
        return ResponseModel(
            responseBody: {}, statusCode: APIStatusCode.internalServerIssue);
